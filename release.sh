...
echo "\-------------------------------------------------------"
sleep 1
mvn versions:set -DgenerateBackupPoms=false -DnewVersion=${VERSION} -pl com.jivesoftware.os.leaps-n-bounds.inheritance.poms:global-repo-management
git add -A
...
echo "\-------------------------------------------------------"
mvn versions:set -DgenerateBackupPoms=false -DnewVersion=${NEXT_VERSION}-SNAPSHOT -pl com.jivesoftware.os.leaps-n-bounds.inheritance.poms:global-repo-management
git add -A
