...
public class LABConcurrentSkipListMapBKP implements LABIndex {
    ...
    private static final AtomicIntegerFieldUpdater<LABConcurrentSkipListMapBKP> headUpdater = AtomicIntegerFieldUpdater
        .newUpdater(LABConcurrentSkipListMapBKP.class, "head");
...
//    }
    ...
    public LABConcurrentSkipListMapBKP(LABConcurrentSkipListMemory comparator) throws Exception {
    ...
    @Override
    public void compute(BolBuffer keyBytes, BolBuffer valueBuffer, Compute remappingFunction) throws Exception {
    ...
    static final class SubRangeEntryStream implements EntryStream {
        ...
        /** Underlying map */
        private final LABConcurrentSkipListMapBKP m;
         ...
         */
        SubRangeEntryStream(LABConcurrentSkipListMapBKP map,
